...
export const GET_HOLDINGS_BEGIN = "GET_HOLDING_BEGIN"
export const GET_HOLDINGS_SUCCESS = "GET_HOLDING_SUCCESS"
export const GET_HOLDINGS_FAILURE = "GET_HOLDING_FAILURE"
  ...
  return dispatch => {
    ...
    console.log(response)
      if (response.status == 200 ){
         ...
         //Message data
         let myHodlings = response.data.map((item) => {
            //Retrieve our current holdinggs -> current
            ...
            return {
              ...
              holding_vallue_change_7d: (item.current_price - price7d)* coin.qty,
              sparkline_in_7d: {
